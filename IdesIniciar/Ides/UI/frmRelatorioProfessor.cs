...
namespace Ides.UI
{
    public partial class frmRelatorioProfessor : Form
    {
        //variaveis usadas para mover painel
        private bool mover;
        private int cX, cY;

        public frmRelatorioProfessor()
        {
            InitializeComponent();
        }

        // -------------------- INICIAR O FORMULÁRIO --------------------
        private void frmRelatorioProfessor_Load(object sender, EventArgs e)
        {
            DAL.RelatorioDAL rDAL = new DAL.RelatorioDAL();
            rDAL.RelatorioProfessor().Fill(dsRelatorios.PROFESSOR);
