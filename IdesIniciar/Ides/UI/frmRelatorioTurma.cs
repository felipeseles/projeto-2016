...
namespace Ides.UI
{
    public partial class frmRelatorioTurma : Form
    {
        //variaveis usadas para mover painel
        private bool mover;
        private int cX, cY;

        public frmRelatorioTurma()
        {
            InitializeComponent();
        }

        // -------------------- INICIAR O FORMULÁRIO --------------------
        private void frmRelatorioTurma_Load(object sender, EventArgs e)
        {
            DAL.RelatorioDAL rDAL = new DAL.RelatorioDAL();
            rDAL.RelatorioTurma().Fill(dsRelatorios.TURMA);
